...
const TestimonialsCard = ({displayImg,name,position,caption,rating}) => {
  return (
    <div className='px-[30px] py-[40px] w-full xl:w-[370px] md:h-[300px] xl:h-[434px] bg-[#fff]
      flex-col md:flex-row xl:flex-col flex gap-6 items-center text-center justify-center font-AguDisplay'>
